...
*/namespace _12._10._2024___815
{
    public class User {
        ...
        public User(string first_name, string last_name, int age, string adress)
        {
        ...
        {
            User creation = new User(this.first_name, this.last_name, this.age, this.adress);
            return creation;
        }
    ...
    internal class Program
    {
        ...
        {
            User creation = new User("John", "Smith", 22, "New Zeland Abc 23");
